...
import hopurd.database.dev.*;
import hopurd.database.dev.Insert;
import hopurd.database.dev.Schema;
...
public class DbMain {
  ...
  public static void init(Boolean dev) {
    production(); // production() hér ef heroku database
    connect();
    if (dev) {
  ...
  private static void production() {
    try {
      ...
      //String uri = "postgres://cvymsjqj:5N8DsWr_zQp_qtzfdsurOVj4GCFEx9iP@balarama.db.elephantsql.com:5432/cvymsjqj";
