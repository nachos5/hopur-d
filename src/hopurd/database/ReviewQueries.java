...
public class ReviewQueries {
  ...
  public static ArrayList<Review> dynamicReviewQuery(JSONObject obj) {
    ...
    if (obj.has(resolveReview(reviewJSONenum.USER)))
      conditions.add("userId = " + obj.get(resolveReview(reviewJSONenum.USER)));
    if (obj.has(resolveReview(reviewJSONenum.TITLE)))
      conditions.add("title = " + obj.get(resolveReview(reviewJSONenum.TITLE)));
    if (obj.has(resolveReview(reviewJSONenum.TEXT)))
      conditions.add("text = " + obj.get(resolveReview(reviewJSONenum.TEXT)));
    if (obj.has(resolveReview(reviewJSONenum.RATING)))
      conditions.add("rating = " + obj.get(resolveReview(reviewJSONenum.RATING)));
    if (obj.has(resolveReview(reviewJSONenum.RATINGMIN)))
      conditions.add("rating >= " + obj.get(resolveReview(reviewJSONenum.RATINGMIN)));
    if (obj.has(resolveReview(reviewJSONenum.RATINGMAX)))
      conditions.add("rating <= " + obj.get(resolveReview(reviewJSONenum.RATINGMAX)));
    if (obj.has(resolveReview(reviewJSONenum.ISPUBLIC)))
      conditions.add("isPublic = " + obj.get(resolveReview(reviewJSONenum.ISPUBLIC)));
    if (obj.has(resolveReview(reviewJSONenum.ORDERBY)))
      orderBy += " order by " + obj.get(resolveReview(reviewJSONenum.ORDERBY));
